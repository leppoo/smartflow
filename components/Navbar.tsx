...
export const Navbar: React.FC<Props> = ({ onHome, onProfile, userName }) => {
  ...
  return (
    <nav className="bg-white border-b border-primary-100 sticky top-0 z-50 no-print">
      <div className="container mx-auto px-4 h-16 flex items-center justify-between max-w-6xl">
        ...
        >
          ...
          <span>SmartFlow <span className="text-primary-300 font-medium">Invoice</span></span>
        </button>

        <div className="flex items-center gap-3">
          <button
            onClick={onProfile}
            className="text-primary-500 hover:text-primary-700 text-sm font-bold transition-colors hidden sm:block bg-primary-50 px-3 py-1.5 rounded-lg border border-primary-100"
          >
            {displayName}
          </button>
          <WallpaperPicker />
