    ...
    <div className="relative" ref={dropdownRef}>
      ...
      {isOpen && (
        <div className="absolute right-0 top-12 bg-white rounded-2xl shadow-2xl border border-primary-100 py-3 px-2 w-56 z-50 animate-in fade-in slide-in-from-top-2 duration-200">
          <p className="text-[10px] font-black text-primary-300 uppercase tracking-widest px-3 mb-2">Wallpaper</p>
          ...
          {/* Upload button */}
          <div className="border-t border-primary-100 mt-2 pt-2 px-1">
            <button
              onClick={() => fileInputRef.current?.click()}
              className="w-full flex items-center gap-2 px-3 py-2.5 rounded-xl text-left text-primary-400 hover:bg-primary-50 hover:text-primary-600 transition-all"
            >
